...
Write-Host "Collecting service information" -ForegroundColor Cyan
...
dotnet publish (Join-Path $currentDir "EventHubToS3\EventHubToS3.csproj")

$publishFolder =  (Join-Path $currentDir "EventHubToS3\bin\Debug\net6.0\publish")
$publishZip =  (Join-Path $currentDir "publish.zip")
...
$appsettingsFile =  (Join-Path $currentDir "EventProducer\appsettings.json")
